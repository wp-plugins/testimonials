...
* Sidebar widgets with innerfade jquery functionality.

* Display specific testimonial(s) within posts or pages using shortcode.

* Modify the design by a click.

* Providing the template for testimonials and it is editable via admin.
...
For upgrading please use the built-in one-click updater .
